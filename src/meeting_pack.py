...
# The house style lives in one place now. Two PDFs going to the same reviewer in the same
# week should not drift apart because their styles were copied rather than shared.
from src.pdf_kit import (ACCENT, BODY, BUL, CAUTION, CELL, CELLH, DEFECT, EYE, FAINT,
                         H1, H2, H3, INK, MUTED, NOTE, OK, RULE, S, SUB, SUNK,
                         bullets, kpis, nf, render, rule, table)
...
if __name__ == "__main__":
    ...
    render(PDF, flow,
           ...
           footer=f"{CORRIDOR_ROAD} corridor - independent audit and assessment")
