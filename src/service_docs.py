...
PIPELINE_ORDER = [
    ...
    ("anomaly",      "integrity screen: six detectors, gated on rediscovery"),
    ("cluster",      "approach typology, gated on a held-out label"),
    ("forecast",     "how short a count can be, leave-one-out"),
