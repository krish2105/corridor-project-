...
const FILES = [
  ...
  { f: "delay.json", label: "Queue, delay and journey time",
    note: "Queue length against available storage, spillback, corridor travel time", kind: "JSON" },
  { f: "economics.json", label: "Cost of delay",
    note: "Banded annual cost; value of time declared as a policy input", kind: "JSON" },
