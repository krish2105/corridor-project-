...
A video/CV counting stage exists in the methodology and is **not yet built**. It is a
later addition, not the current subject.
...
| Corridor order | Continuity-derived ordering agrees with map pins, or the disagreement is reported |

### Video/CV stages (not yet built)
